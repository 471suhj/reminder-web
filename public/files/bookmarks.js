...
fncAutoloadSetup(fncInsertFile, fncPrintCnt, lblTitle.dataset.id, 'bookmarks');
...
async function fncInsertFile(jsnRes, last, msgPos, msgNeg, checkItems){
    ...
    await fncAddItems(jsnRes, last, msgPos, msgNeg, checkItems, strHtml, false, 3, objCnt, fncPrintCnt);
